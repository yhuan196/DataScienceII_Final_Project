...
$$log( \frac{p(RecoverytimeLong)}{1-p(RecoverytimeLong)}) = -2.07377 +0.47457\times gender1+0.04810\times race2-0.06047\times race3+0.07020\times race4-0.33680\times smoking1-0.50352 \times smoking2-0.34676\times hypertension1 -0.07480\times diabetes1+0.69695\times vaccine1 -0.61790\times severity1 + 1.18222\times study2+0.01115 \times study3 + s(age) + s(sbp) + s(ldl) + s(bmi) + s(height) + s(weight)$$
