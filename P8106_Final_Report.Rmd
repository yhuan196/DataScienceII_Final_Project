...
After resampling, 8 models share a common set of resampled datasets from train set. By 10-fold cross-validation, the boosting model has least mean value of RMSE. The RMSE of all eight model are showed below.
...
## Interpretions of some significant coefficients on final model
...
The mean RMSE of train error is 17.48103 and the mean RMSE of test error is 21.36644, which indicates that the model has good performance on training and test.
