...
```{r, echo=FALSE, fig.cap="LIME Plot", out.width = '120%'}
...
Heres is the partial dependence plots of BMI and height which are most significant variables for model. (figure 6)
